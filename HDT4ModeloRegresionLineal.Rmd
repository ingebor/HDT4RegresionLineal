...
```
El valor de R cuadrado aumentó, además se noto que la media era un valor grande, esto se debe probablemente a la gran cantidad de datos atipicos que se evidencian en el gráfico de residuos
